...
/**
 * Show and hide, on the two fields that hold something worth hiding.
 *
 * The eye with a line through it means "hidden, and this is how you look" — the
 * pair every browser and password manager draws, which is the point: nobody is
 * learning a new symbol on the one screen where they are typing a credential.
 * The name is on the button either way, since an icon says nothing aloud.
 */
...
export function SortAlphaIcon() {
  return (
    ...
    >
      ...
      <polyline points="17 6 20 3 23 6" />
...
/** The keyboard Peri draws for itself — see `ui/keyboard.tsx`. */
