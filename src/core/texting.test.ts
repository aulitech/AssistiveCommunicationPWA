...
const FOUND_BY_INITIALS = [
  'BRB', 'BBL', 'BRT', 'GTG', 'TTYL', 'OMW', 'AFK', 'ASAP', 'ETA', 'LMK', 'HMU',
  'IDK', 'IDC', 'IKR', 'NGL', 'TBH', 'TBF', 'TY', 'TYVM', 'NP', 'YW', 'GL', 'GN',
  'GM', 'ILY', 'IMO', 'IMHO', 'AFAIK', 'IIRC', 'FWIW', 'BTW', 'FYI', 'OTOH',
  'TLDR', 'ICYMI', 'TIL', 'YMMV', 'POV', 'AKA', 'PSA', 'LOL', 'ROFL', 'JK',
