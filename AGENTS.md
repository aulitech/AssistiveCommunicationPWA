...
- **A chip is never both a remove and a handle.** Two targets in one place is the worst thing to give somebody aiming by gaze, and a dwell meant to put a word down would delete it. Arranging replaces the ×; closing the list puts down whatever is in the air.
